...
import { BotaoMaisInfoQuartos, ContainerPrecoQuartos, ContainerQuartos, ContainerTxtQuartos, ItemListaQuartos, ListaQuartos, SubcontainerQuartos, TituloQuartos, TxtQuartos } from '../styles/QuartosStyles'
    ...
    return (
        <ContainerQuartos> {/* Container column */}
            ...
            <SubcontainerQuartos> {/* Container quarto row */}
                <img src="/assets/quarto-casal-quartospg.png" alt="Foto do quarto de casal" />
            ...
            <SubcontainerQuartos> {/* Container quarto row */}
                <img src="/assets/quarto-de-luxoquartospg.png" alt="Foto do quarto de luxo" />
                <ContainerTxtQuartos>  {/* Container txt quarto column */}
            ...
            <SubcontainerQuartos> {/* Container quarto row */}
                <img src="/assets/quarto-solteiroquartospg.png" alt="Foto do quarto de solteiro" />
                <ContainerTxtQuartos>  {/* Container txt quarto column */}
